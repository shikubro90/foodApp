    ...
    <div className="fixed z-50 w-screen bg-slate-300 p-6 px-16">
        ...
        <div className='hidden md:flex w-full h-full bg-red-400'>
          ...
          <ul className='flex items-center justify-center gap-8 ml-auto'>
            <li className='text-base text-textColor curso'>Home</li>
            <li className='text-base text-textColor curso'>Menu</li>
            <li className='text-base text-textColor curso'>About</li>
            <li className='text-base text-textColor curso'>Service</li>
          </ul>
