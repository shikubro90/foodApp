  ...
  return (
    <div className="fixed z-50 w-screen p-6 px-16">
      ...
      <div className="hidden md:flex w-full h-full">
        ...
        <div className="relative flex items-center justify-center ml-5 curso">
          <IoMdBasket className="text-xl text-gray-700" />
          <span className="rounded-full w-5 h-5 bg-cart bg-car bg-red-600 flex justify-center items-center text-[.6rem] text-white -top-2 -right-2 absolute">
            2
          </span>
        </div>
      </div>
