        ...
        <div className="w-full h-full absolute top-0 left-0 py-4 flex flex-wrap items-center justify-center gap-4">
          {heropData &&
            heropData.map(({id,name,decp,imageSrc,price}) => {
              return (
                <div key={id} className="w-90 lg:w-192 min-w-[190px] p-4 bg-red-500 bg-cardOverlay backdrop-blur-md flex flex-col items-center justify-center rounded-md drop-shadow-lg">
