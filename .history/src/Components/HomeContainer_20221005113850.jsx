...
const HomeContainer = () => {
  return (
    <section className="grid grid-cols-1 md:grid-cols-2 gap-2 w-full" id="home">
      ...
      <div className="py2 flex-1 flex items-center justify-center">
        <img
          src={HeroBg}
          className="ml-auto h-370 w-full lg:w-auto lg:h-650"
          alt="heroBg"
        />
        <div className='w-full h-full absolute flex item-center justify-center'>
          <div className='w-192 p-2 bg-red-500'></div>
        </div>
      </div>
    </section>
  )
