        ...
        <div className="relative">
          ...
          {isMenu && (
            ...
            >
              ...
              <p className="bg-gray-200 align px-4 py-2 flex items-center gap-3 cursor-pointer hover:bg-slate-100 transition-all duration-100 ease-in-out text-textColor text-base">
                Logout <FiLogOut />
              </p>
            </motion.div>
          )}
