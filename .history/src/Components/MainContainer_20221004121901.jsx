    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
      <div className="py-2 flex-1 flex flex-col items-start md:items-start justify-center gap-6">
        ...
        <p className="text-[2.5rem] font-bold tracking-wide text-headingColor md:text-[4.25rem]">
          Fastest Delivery in{" "}
          <span className="text-orange-400 text-[3rem] md:text-[5rem]">Your City</span>
        </p>
        <p className="text-textColor text-base text-center md:text-left md:w-[]">
        ...
        <button className='md:w-auto bg-gradient-to-br from-orange-400 to-orange-500 w-full px-4 py-2 rounded-lg hover:shadow-lg transition-all ease-in-out'>Order Now</button>
      </div>
