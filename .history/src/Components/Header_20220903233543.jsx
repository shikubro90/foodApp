      ...
      <div className="hidden md:flex w-full h-full items-center justify-between">
        ...
        <div className="flex justify-center items-center">
          ...
          <div className="relative flex items-center justify-center ml-5 cursor-pointer">
            ...
            <motion.span whileHover={} className="rounded-full w-5 h-5 bg-cart bg-car bg-red-600 flex justify-center items-center text-[.6rem] text-white -top-4 -right-2 absolute">
              2
            </span>
            </motion.div>
          </div>
