    ...
    <section className="grid grid-cols-1 md:grid-cols-2 gap-2 w-full" id="home">
      ...
      <div className="py-2 flex-1 flex items-center relative">
        <img
          ...
          alt="heroBg"
        />
        <div className="w-full h-full absolute top-0 left-0 py-4 flex flex-wrap items-center justify-center gap-4">
          {heropData &&
            heropData.map(({id,name,decp,imageSrc,price}) => {
              return (
                <div key={id} className="lg:w-190 p-4 bg-red-500 bg-cardOverlay backdrop-blur-md flex flex-col items-center justify-center rounded-md drop-shadow-lg">
                  ...
                  <p className="text-sm font-semibold text-headingColor lg:my-3">
