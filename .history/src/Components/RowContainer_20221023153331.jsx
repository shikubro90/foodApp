  ...
  return (
    ...
    >
      {data &&
        data.map((data) => {
          return (
            <div key={data.id} className="w-300 min-w-[300p] md:w-340 my-12 h-auto md:px-5 backdrop-blur-lg bg-cardOverlay rounded-lg drop-shadow-lg hover:drop-shadow-2xl">
