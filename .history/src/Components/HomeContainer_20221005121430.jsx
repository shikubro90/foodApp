    ...
    <section className="grid grid-cols-1 md:grid-cols-2 gap-2 w-full" id="home">
      ...
      <div className="py-2 flex-1 flex items-center relative">
        <img
          ...
          alt="heroBg"
        />
        <div className="w-full h-full absolute top-0 left-0 px-32 py-4 flex item-center justify-center">
          <div className="w-192 p-2 bg-red-500 bg-cardOverlay backdrop-blur-md flex items-center justify-center rounded-md">
            <img className="w-40" src={I1} alt="I1" />
          </div>
        </div>
      </div>
    </section>
