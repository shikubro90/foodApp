      ...
      <section className="w-full my-6">
        <div className="w-full flex items-center justify-between">
          ...
          <div className="hidden md:flex gap-3 items-center">
            <motion.div whileTap={{scale: }} className="w-8 h-8 bg-orange-300 rounded-lg flex items-center justify-center hover:shadow-lg cursor-pointer hover:bg-orange-500"></motion.div>
            <motion.div whileTap={{scale: }} className="w-8 h-8 bg-orange-300 rounded-lg flex items-center justify-center hover:shadow-lg cursor-pointer hover:bg-orange-500"></motion.div>
          </div>
        </div>
      </section>
