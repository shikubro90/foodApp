  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
      <div className="py-2 flex-1 flex flex-col items-start md:items-center justify-center">
        ...
        <p className='text-'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Est commodi sint in earum non, ut laborum quas labore magni quasi vel quam ratione facere quis, ab recusandae deleniti modi? Nobis.</p>
      </div>
