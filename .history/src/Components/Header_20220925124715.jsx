        ...
        <div className="relative">
          ...
          {isMenu && (
            ...
            >
              ...
              <p className="mx-2 px-2  bg-gray-200  px-4 py-2 flex items-center justify-center gap-3 cursor-pointer hover:bg-gray-300 transition-all duration-100 ease-in-out text-textColor text-base">
                Logout <FiLogOut />
              </p>
            </motion.div>
          )}
