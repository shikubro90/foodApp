        ...
        <div className="flex justify-center items-center">
          ...
          <div className="relative">
            ...
            <div className='w-40 shadow-xl absolute bg-gray-50 right-0 top-12 rounded-lg flex flex-col px-4 py-2'>
              <p className='flex items-center gap-3 cursor-pointer hover:bg-sca'>New Item <GrAdd/></p>
              <p className='flex items-center gap-3 cursor-pointer hover:bg-sca'>Logout <FiLogOut/></p>
            </div>
