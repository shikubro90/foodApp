      ...
      <section className="w-full my-6">
        <div className="w-full flex items-center justify-between">
          ...
          <div className="hidden md:flex gap-3 items-center">
            <div className="w-8 h-8 bg-orange-3200 rounded-lg flex items-center justify-center hover:shadow-lg cursor-pointer hover:bg-orange-500"></div>
            <div className="w-8 h-8 bg-orange-500 rounded-lg flex items-center justify-center hover:shadow-lg cursor-pointer hover:bg-orange-500"></div>
          </div>
        </div>
      </section>
    </div>
