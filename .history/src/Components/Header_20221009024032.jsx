          ...
          {isMenu && (
            ...
            >
              ...
              <ul className="flex flex-col">
                <li
                onC className="text-base text-textColor cursor-pointer hover:text-gray-600 duration-100 ease-in-out hover:bg-slate-100 px-4 py-2">
                  Home
                </li>
                <li 
                onCclassName="text-base text-textColor cursor-pointer hover:text-gray-600 duration-100 ease-in-out hover:bg-slate-100 px-4 py-2">
                  Menu
                </li>
                <li 
                onCclassName="text-base text-textColor cursor-pointer hover:text-gray-600 duration-100 ease-in-out hover:bg-slate-100 px-4 py-2">
