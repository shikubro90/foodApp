      ...
      <div className="hidden md:flex w-full h-full items-center justify-between">
        ...
        <div className="flex justify-center items-center">
          ...
          <div className="relative">
            ...
            {isMenu && (
              <motion.div initial={{opacity: 0, scale: 0.6}} initial={{opacity: 0, scale: 0.6}} className='w-40 shadow-xl absolute bg-gray-50 right-0 top-12 rounded-lg flex flex-col'>
